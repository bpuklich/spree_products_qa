module SpreeProductsQa
  module Generators
    class InstallGenerator < Rails::Generators::Base
      ...
      def add_javascripts
        append_file 'vendor/assets/javascripts/spree/frontend/all.js', "//= require spree/frontend/spree_products_qa\n"
        append_file 'vendor/assets/javascripts/spree/backend/all.js', "//= require spree/backend/spree_products_qa\n"
      end
      ...
      def add_migrations
        run 'bundle exec rake railties:install:migrations FROM=spree_products_qa'
      end
